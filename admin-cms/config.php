...
//    define( 'K_DB_NAME', 'mojo_db' );
    define( 'K_DB_NAME', 'localmojo' );
    // 5.
    // Database username
//    define( 'K_DB_USER', 'mojoadmin' );
    define( 'K_DB_USER', 'root' );
    // 6.
    // Database password 
//    define( 'K_DB_PASSWORD', 'HelloMojo*289' );
    define( 'K_DB_PASSWORD', 'root' );
    // 7.
    // MySQL hostname (it will usually be 'localhost' )
//    define( 'K_DB_HOST', 'mojomobility.netfirmsmysql.com' );
