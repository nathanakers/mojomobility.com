		...
		<div class="container">
			<div class="row">
				<div class="span16">
						...
						<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span>Menu </span><i class="icon-reorder"></i></a>
			 
						<!-- Be sure to leave the brand out there if you want it shown -->
						<a class="brand" href="home"><img src="assets/images/logo.png" alt="<cms:show g_name /> Logo" /></a>			 
