...
<head>
	...
	<link rel="shortcut icon" href="/_testing/assets/images/favicon.ico?t=<?php echo filemtime('assets/images/favicon.ico'); ?>">
	<link rel="apple-touch-icon" href="/_testing/assets/images/apple-touch-icon.png?t=<?php echo filemtime('assets/images/apple-touch-icon.png'); ?>">
	<?php /* CSS:
		   1. Bootstrap 2.3.0 base and responsive addition
		   2. FontAwesome 3.0
		   3. Google Font CSS declaration(s)
		   4. Main Project CSS (filemtime used) */ ?>
	<link rel="stylesheet" href="/_testing/assets/css/bootstrap.css">
	<!--link rel="stylesheet" href="/_testing/assets/css/bootstrap-responsive.css"-->
	<link rel="stylesheet" href="/_testing/assets/css/font-awesome.min.css">
	<link href='http://fonts.googleapis.com/css?family=Telex' rel='stylesheet' type='text/css'>
	<link href='http://fonts.googleapis.com/css?family=Arbutus+Slab' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" href="/_testing/assets/css/main.css?t=<?php echo filemtime('assets/css/main.css'); ?>">
	<?php /* JS:
		   * modernizer & jquery included
		   * all other javascripts are included at the base in html-app-footer.php */ ?>
	<script src="/_testing/assets/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
